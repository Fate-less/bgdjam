...
public class FileB : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (seed == "Medium")
        {
            ...
            Instantiate(bulat, spawnPos4.position, Quaternion.identity).transform.SetParent(transform);
            Instantiate(atas, spawnPos5.position, Quaternion.identity).transform.SetParent(transform);
            Instantiate(bawah, spawnPos6.position, Quaternion.identity).transform.SetParent(transform);
        }
        if (seed == "Hard")
        {
            Instantiate(kotak, spawnPos1.position, Quaternion.identity).transform.SetParent(transform);
